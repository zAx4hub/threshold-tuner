...
> Tune classification thresholds for real costs

**Author:** zAx4hub

## Problem

Tune classification thresholds for real costs. Teams often rely on closed SaaS, brittle scripts, or untested prototypes for this niche.

## Solution

`threshold-tuner` is an installable TypeScript/Node toolkit by **zAx4hub** with a real **parser** engine, CLI, examples, and tests.
...
1. Core parser engine tailored to the problem
